...
This repository benchmarks end-to-end cybersecurity product work: research,
product definition, design specification, and frontend execution. A frozen
prompt under `benchmark/prompts/` is the run's authoritative task.
