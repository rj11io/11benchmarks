...
const suite = {
  title: "crypto-dashboard-bench",
  objective:
    "Compare end-to-end crypto product research, strategy, design, domain trust, visual execution, and frontend craft.",
...
function loadReview() {
  const cycles = path.join(process.cwd(), "benchmark", "cycles")
  const files = fs.existsSync(cycles)
    ? fs.readdirSync(cycles).flatMap((id) => {
        const file = path.join(cycles, id, "review", "data.json")
      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-8 sm:px-8 sm:py-12">
        <header className="border-b border-border/60 pb-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <a
              href="https://github.com/rj11io/11bench/tree/main/v1/crypto-dashboard-bench"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_320px] lg:items-end">
            ...
            <div className="rounded-lg border border-border bg-card p-5">
              ...
              <a
                href={`https://github.com/rj11io/11bench/blob/main/v1/crypto-dashboard-bench/benchmark/cycles/${id}/report/report.md`}
                target="_blank"
                rel="noreferrer"
        ...
        <section className="mt-10 grid gap-4 lg:grid-cols-2">
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {list(record(review.benchmark).evidenceSurfaces).map(
                (surface) => (
                  <span
                    key={String(surface)}
          ...
          <div className="rounded-lg border border-border bg-muted/30 p-5">
            ...
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              ...
              {text(metadata.pricing, "unavailable")}. Unknown work remains
              labeled in the canonical accounting artifact.
            </p>
          </div>
        </section>
