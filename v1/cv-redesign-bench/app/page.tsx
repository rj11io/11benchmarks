...
const suite = {
  title: "cv-redesign-bench",
  objective:
    "Recover and improve the CV from the same PDFs, then execute a responsive web CV whose print output is exactly two A4 pages.",
  artifacts: ["research.md", "content.md", "design.md"],
}
      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-8 sm:px-8 sm:py-12">
        <header className="border-b border-border/60 pb-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <a
              href="https://github.com/rj11io/11bench/tree/main/v1/cv-redesign-bench"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_320px] lg:items-end">
            ...
            <div className="rounded-lg border border-border bg-card p-5">
              ...
              <a
                href={`https://github.com/rj11io/11bench/blob/main/v1/cv-redesign-bench/benchmark/cycles/${id}/report/report.md`}
                target="_blank"
                rel="noreferrer"
        ...
        <section className="grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-border bg-border">
          <Metric
            ...
            value={String(
              number(lifecycle.totalRuns) ??
                metadata.registeredRunCount ??
                rows.length
            )}
          />
          <Metric
        ...
        <section className="mt-10 rounded-lg border border-border bg-muted/30 p-5">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            ...
            {text(metadata.pricing, "unavailable")} · print-A4 evidence remains
            a first-class surface in this benchmark.
          </p>
        </section>
